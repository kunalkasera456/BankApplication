...
public class SBIAccount implements BankInterface{
    ...
    public SBIAccount(String name, int balance, String password) {   //constructor which is pass by user
        this.name = name;
    ...
    @Override
    public String withdraw(String enteredPassword, int amount) {
